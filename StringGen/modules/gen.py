...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("ll_ANIME_DP_ll"))
        else:
            ...
            await client.join_chat("ll_ANIME_DP_ll")
    except KeyError:
        pass
    try:
